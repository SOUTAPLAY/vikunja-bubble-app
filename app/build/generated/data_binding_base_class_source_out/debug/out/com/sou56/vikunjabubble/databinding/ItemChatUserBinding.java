...
public final class ItemChatUserBinding implements ViewBinding {
  ...
  private ItemChatUserBinding(@NonNull LinearLayout rootView, @NonNull TextView textMessage) {
  ...
  public static ItemChatUserBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemChatUserBinding((LinearLayout) rootView, textMessage);
    }
